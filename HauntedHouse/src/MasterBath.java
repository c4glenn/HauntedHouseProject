...
public class MasterBath extends Room {
    ...
    Pane display() {
		...
		BackgroundImage myBI= new BackgroundImage(new Image("https://www.homestratosphere.com/wp-content/uploads/2017/11/large-master-bathroom-nov9-17.jpg,true"), BackgroundRepeat.REPEAT, BackgroundRepeat.NO_REPEAT, BackgroundPosition.DEFAULT,BackgroundSize.DEFAULT);
